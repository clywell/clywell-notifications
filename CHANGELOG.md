...
- Bumped `Scriban` from `7.0.3` to `7.0.6`
...
#### `Clywell.Core.Notifications.Renderer.Scriban`
- Bumped `Scriban` from `6.6.0` to `7.0.3`

#### `Clywell.Core.Notifications.SignalR`
- Added explicit `Newtonsoft.Json` `13.0.4` dependency to mitigate a known security vulnerability in the transitive dependency chain from `Microsoft.AspNetCore.SignalR.Core`
...
[Unreleased]: https://github.com/clywell/clywell-notifications/compare/v1.2.0...HEAD
[1.2.0]: https://github.com/clywell/clywell-notifications/compare/v1.1.0...v1.2.0
